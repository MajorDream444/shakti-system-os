      ...
      <div className="max-w-2xl mx-auto w-full my-auto py-8 z-10 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
          <div className="flex flex-col items-center justify-center gap-4 py-6 border border-[#D8C5B0]/10 rounded-2xl bg-white/[0.01]">
            ...
            <div className="font-sans text-base text-[#c7b6a2] uppercase tracking-[0.18em]">
          ...
          <div className="border border-[#E27A3F]/20 rounded-2xl bg-[#4A1F24]/10 p-6 flex flex-col justify-center items-center text-center">
            ...
            <p className="font-sans text-base text-[#c7b6a2] mt-1">
              {isReadyToRequest
            ...
            <button
              ...
              className={`mt-4 min-h-11 px-6 py-2 rounded-full font-sans font-bold text-base tracking-[0.1em] uppercase transition-all duration-300 ${
                isReadyToRequest
              ...
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center border transition-all ${
                  item.checked
                    ...
                    : 'border-[#bda994] bg-transparent'
                }`}
              >
                {item.checked && <span className="text-[#090707] text-base font-bold">✓</span>}
              </div>
          ...
          <div className="fixed inset-0 bg-[#090707]/95 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              ...
              <button
                ...
                className="absolute top-6 right-6 min-h-11 px-3 text-[#C8B7A5] hover:text-[#F6EFE7] font-sans text-base font-bold tracking-[0.1em] uppercase cursor-pointer"
              >
                Close
              </button>
              ...
              {requestStep === 1 ? (
                <form onSubmit={handleConfirmRequest} className="flex flex-col gap-5">
                  <div className="text-center">
                    <span className="font-sans text-base tracking-[0.3em] uppercase text-[#E27A3F]">Retreat Discernment</span>
                    <h3 className="font-serif text-3xl text-[#F6EFE7] mt-1.5">Request Sacred Passage</h3>
                    <p className="font-sans text-base text-[#C8B7A5] mt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center py-4 border-y border-white/5 my-2">
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-white/[0.01]">
                      ...
                      <span className="font-sans text-base text-[#C8B7A5] uppercase">Timeline</span>
                      <span className="font-serif text-base text-[#F6EFE7]">Oct 14 - 28</span>
                    </div>
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-white/[0.01]">
                      <MapPin className="w-5 h-5 text-[#E27A3F]" />
                      <span className="font-sans text-base text-[#C8B7A5] uppercase">Location</span>
                      <span className="font-serif text-base text-[#F6EFE7]">Kedar Valley</span>
                    </div>
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-white/[0.01]">
                      <ShieldCheck className="w-5 h-5 text-[#E27A3F]" />
                      <span className="font-sans text-base text-[#C8B7A5] uppercase">Access State</span>
                      <span className="font-serif text-base text-[#F6EFE7]">Available to Request</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="font-sans text-base font-bold tracking-[0.08em] uppercase text-[#C8B7A5]">Name in Practice</label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="font-sans text-base font-bold tracking-[0.08em] uppercase text-[#C8B7A5]">Email</label>
                        <input
                          type="email"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="font-sans text-base font-bold tracking-[0.08em] uppercase text-[#C8B7A5]">WhatsApp</label>
                        <input
                          type="tel"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="font-sans text-base font-bold tracking-[0.08em] uppercase text-[#C8B7A5]">Nourishment Preference</label>
                        <select
                          value={formData.diet}
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="font-sans text-base font-bold tracking-[0.08em] uppercase text-[#C8B7A5]">Prior Stillness Experience</label>
                        <select
                  ...
                  <label className="flex items-start gap-3 text-left font-sans text-base leading-relaxed text-[#C8B7A5]">
                    <input
                      type="checkbox"
                  ...
                  {requestError && (
                    <p role="alert" className="font-sans text-base text-[#F0A0A0]">
                      {requestError}
                    </p>
                  )}
                  ...
                  <div className="mt-4 pt-4 border-t border-white/5 flex flex-col gap-3">
                    <button
                      ...
                      className="w-full min-h-12 py-3 bg-gradient-to-r from-[#C35A2E] to-[#E27A3F] text-white font-sans font-bold text-base tracking-[0.1em] uppercase rounded-full shadow-[0_0_20px_rgba(226,122,63,0.3)] transition-all hover:scale-[1.02]"
                    >
                      {requestLoading ? 'Sharing for review...' : 'Request Human Review'}
                    </button>
                    <span className="text-center font-sans text-base text-[#C8B7A5] uppercase tracking-[0.08em] block">
                ...
                >
                  ...
                  <p className="font-sans text-base text-[#c7b6a2] max-w-sm">
                  ...
                  <div className="border border-white/5 rounded-2xl p-4 bg-white/[0.01] max-w-sm w-full text-left mt-2">
                    <span className="font-sans text-base tracking-widest text-[#E27A3F] block uppercase mb-1">Next Step</span>
                    <span className="font-sans text-base text-[#C8B7A5]">
                      A human conversation is required before any retreat doorway can be considered.
                    </span>
                  </div>
                  <button
                    onClick={() => { setRequestActive(false); setRequestStep(1); }}
                    className="mt-6 px-6 py-2 bg-white/5 hover:bg-white/10 text-white font-sans font-semibold text-base tracking-widest uppercase rounded-full transition-all"
                  >
                    Return to Shala
                  </button>
                </motion.div>
