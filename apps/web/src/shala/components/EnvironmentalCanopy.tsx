    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-30 flex items-center gap-2">
        <button
          ...
          className={`flex items-center gap-2 p-2 px-3 rounded-full border text-base font-sans font-semibold tracking-[0.16em] text-transform: uppercase transition-all duration-300 ${
            soundActive
        ...
        {soundActive && (
          <button
            ...
            className="p-2 rounded-full border border-white/10 bg-[#090707]/80 hover:bg-[#090707]/100 hover:border-[#E27A3F]/30 text-[#D8C5B0] text-base font-sans font-semibold tracking-[0.16em] text-transform: uppercase transition-all duration-300"
          ...
          {isOpen && (
            ...
            >
              ...
              <div className="flex items-center gap-2 pb-3 mb-4 border-b border-white/5">
                ...
                <span className="font-sans font-bold text-base tracking-[0.24em] text-transform: uppercase text-[#E27A3F]">
                  MOUNTAIN CANOPY
                </span>
              </div>
              ...
              {/* Seasons Grid */}
              <div className="mb-4">
                <label className="block font-sans text-base tracking-[0.16em] text-transform: uppercase text-[#bda994] mb-2">
                  Mountain Season
                </label>
                  ...
                  {seasons.map((s) => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-1.5 rounded-lg border text-base font-semibold tracking-wider transition-all ${
                          isSelected
                            ? 'border-[#E27A3F]/40 bg-[#E27A3F]/10 text-[#F6EFE7]'
                            : 'border-white/5 bg-white/[0.01] text-[#bda994] hover:border-white/15'
                        }`}
                      >
                        {s.label}
                      </button>
                  ...
                  {times.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 p-2 rounded-lg border text-left text-base font-semibold transition-all ${
                          isSelected
                            ? 'border-[#E27A3F]/40 bg-[#E27A3F]/10 text-[#F6EFE7]'
                            : 'border-white/5 bg-white/[0.01] text-[#bda994] hover:border-white/15'
                        }`}
