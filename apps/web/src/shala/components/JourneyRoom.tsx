    ...
    >
      ...
      <div className="w-full flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-sans font-semibold text-base tracking-[0.24em] text-transform: uppercase text-[#cdbfa8]">
            PERSONAL JOURNEY
          </span>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto w-full my-auto py-8 z-10 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-6">
          <div className="border border-[#D8C5B0]/10 rounded-2xl p-6 bg-white/[0.005]">
            <span className="font-sans font-bold text-base tracking-[0.24em] text-transform: uppercase text-[#E27A3F] block mb-4">
          ...
          <div className="p-6 text-center border border-[#E27A3F]/20 rounded-2xl bg-[#4A1F24]/10 flex flex-col justify-center items-center relative group overflow-hidden">
            ...
            <div className="font-sans text-base text-[#c7b6a2] mt-1 tracking-wider uppercase">
              Open sanctuary continuity in this release
            </div>
            <button
              id="journey-ascend-initiation"
              onClick={() => setIsAscending(true)}
              className="mt-4 px-5 py-2 bg-[#E27A3F] hover:bg-[#C35A2E] text-white font-sans font-semibold text-base tracking-widest text-transform: uppercase rounded-full transition-all duration-300 shadow-[0_0_12px_rgba(226,122,63,0.3)] hover:scale-105 cursor-pointer animate-[pulse_4s_infinite]"
            >
        ...
        <div className="border-t border-[#D8C5B0]/10 pt-6">
          <div className="font-sans font-semibold text-base tracking-[0.2em] uppercase text-[#bda994] mb-4">
            Doorway States
          </div>
                ...
                <div
                  ...
                  className={`px-4 py-3 rounded-xl border flex flex-col gap-0.5 min-w-[120px] transition-all ${
                    active
                      ...
                      : 'border-white/5 bg-white/[0.005] text-[#c7b6a2] opacity-50'
                  }`}
                >
                  <span className="font-serif text-md">{stage.state}</span>
                  <span className="font-sans text-base tracking-wide uppercase opacity-80">{stage.desc}</span>
                </div>
              );
            })}
          </div>
        ...
        <div className="relative pl-6">
          ...
          <div className="relative mb-6">
            ...
            <div className="font-sans text-base text-[#c7b6a2] mt-1">
          ...
          <div className="relative mb-6 opacity-60">
            <div className="absolute left-[-24px] top-1 w-2.5 h-2.5 rounded-full bg-[#c7b6a2]" />
            <h3 className="font-serif text-xl text-[#D8C5B0]">Began {seekerState.currentPathway}</h3>
            <div className="font-sans text-base text-[#c7b6a2] mt-1">28 June</div>
          </div>

          <div className="relative opacity-40">
            <div className="absolute left-[-24px] top-1 w-2.5 h-2.5 rounded-full bg-[#c7b6a2]" />
            <h3 className="font-serif text-xl text-[#D8C5B0]">Entered the Vault</h3>
            <div className="font-sans text-base text-[#c7b6a2] mt-1">Spring Equinox</div>
          </div>
        </div>
      </div>
          ...
          <div className="fixed inset-0 bg-[#090707]/95 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              ...
              <button
                ...
                className="absolute top-6 right-6 text-[#c7b6a2] hover:text-[#F6EFE7] font-sans text-base tracking-widest uppercase cursor-pointer"
              >
                Close
              </button>

              <div className="text-center">
                <span className="font-sans text-base tracking-[0.3em] uppercase text-[#E27A3F]">Human Review</span>
                <h3 className="font-serif text-3xl md:text-4xl text-[#F6EFE7] mt-2">Request a Protected Doorway</h3>
                <p className="font-serif italic text-base text-[#c7b6a2] mt-1">
              ...
              {isSuccess ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                  ...
                  <p className="font-sans text-base text-[#c7b6a2]">No credential or access grant is created from this room.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-[0.9fr_1.1fr] gap-6 mt-2">
                  <div className="flex flex-col gap-2">
                    {PATHWAY_STATES.map((stage) => (
                      ...
                      >
                        ...
                        <span className="font-sans text-base tracking-wide uppercase text-[#c7b6a2] block mt-1">
                          {stage.desc}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="border border-[#D8C5B0]/10 rounded-3xl p-5 bg-white/[0.005] flex flex-col justify-between">
                    <div>
                      ...
                      <p className="font-sans text-base text-[#c7b6a2] mt-2 leading-relaxed">
                      ...
                      <div className="mt-5 border-t border-white/5 pt-4">
                        <span className="font-sans text-base tracking-widest uppercase text-[#bda994] block mb-2">What stays protected</span>
                        <ul className="flex flex-col gap-1.5">
                          {['No access is granted here', 'No retreat readiness is decided here', 'No initiation is automated'].map((item) => (
                            <li key={item} className="font-sans text-base text-[#C8B7A5] flex items-start gap-2">
                    ...
                    <div className="mt-6 pt-4 border-t border-white/5 flex flex-col gap-3">
                      <button
                        ...
                        className="w-full py-3 bg-gradient-to-r from-[#C35A2E] to-[#E27A3F] text-white font-sans font-semibold text-base tracking-widest uppercase rounded-full shadow-[0_0_20px_rgba(226,122,63,0.3)] transition-all hover:scale-[1.02] cursor-pointer"
                      >
                        Hold This Request Locally
                      </button>
                      <span className="text-center font-sans text-base text-[#bda994] uppercase tracking-wider block">
