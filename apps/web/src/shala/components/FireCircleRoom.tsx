    ...
    >
      ...
      <div className="max-w-2xl mx-auto w-full my-auto py-8 z-10 flex flex-col items-center">
        ...
        <div className="flex gap-2.5 mt-8 border-b border-white/5 pb-4 w-full justify-center">
          {['Foundations', 'Pranayama', 'Embodiment'].map((cat) => (
            <button
              ...
              className={`font-sans font-semibold text-base tracking-[0.14em] text-transform: uppercase pb-1.5 transition-all ${
                selectedCategory === cat
                  ? 'text-[#E27A3F] border-b-2 border-[#E27A3F]'
                  : 'text-[#c7b6a2] hover:text-[#D8C5B0]'
              }`}
            >
              {cat}
            </button>
        ...
        <div className="flex flex-col gap-3 mt-6 w-full max-w-lg">
          <p className="font-sans text-base text-[#c7b6a2] uppercase tracking-[0.18em] mb-1">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-sans text-base text-[#c7b6a2] mt-1">{practice.duration}</div>
                </div>
              </div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: '15px', color: '#c7b6a2' }}>
                begin ›
              </div>
            </button>
          ))}
