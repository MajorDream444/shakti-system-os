    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-16 top-1/3 z-5 select-none pointer-events-none flex items-center justify-center gap-8 md:gap-12 flex-wrap">
        {journalEntries.length === 0 ? (
          <div className="text-center opacity-40 font-sans text-base text-[#c7b6a2] animate-pulse">
      ...
      <div className="w-full flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-sans font-semibold text-base tracking-[0.24em] text-transform: uppercase text-[#7fa39c]">
            REFLECTION POOL
          </span>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto w-full my-auto py-8 z-10 flex flex-col gap-8">
        <div>
          <span className="font-sans font-semibold text-base tracking-[0.28em] text-transform: uppercase text-[#7f938c]">
            ...
            <AnimatePresence>
              {isSuccess && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute bottom-4 left-4 font-serif italic text-base text-[#7fa39c]"
                >
        ...
        {journalEntries.length > 0 && (
          <div className="mt-4">
            <div className="font-sans font-semibold text-base tracking-[0.2em] uppercase text-[#bda994] mb-3">
              Earlier Pages
            </div>
            <div className="flex flex-col gap-3 max-h-[180px] overflow-y-auto scrollbar-none">
              {journalEntries.map((entry) => (
                ...
                >
                  <div className="font-sans text-base text-[#c7b6a2]">{entry.date}</div>
