...
import { Compass, BookOpen, Flame, PenTool, Mountain, Sun, Moon } from 'lucide-react';
...
export const CourtyardRoom: React.FC<CourtyardRoomProps> = ({
  ...
  /* The external canopy intentionally synchronizes this room's local selector. */
      ...
      <div className="max-w-2xl mx-auto w-full my-auto py-12 z-10 flex flex-col gap-10">
        ...
        <div>
          ...
          <h1 className="font-serif text-3xl md:text-5xl leading-tight text-[#F6EFE7] mt-3">
            Welcome to Shri Shakti Shala, <span className="italic">{seekerName}</span>.
          </h1>
