...
test.describe("Sprint 12A visual review evidence", () => {
  test("desktop walkthrough captures authored orientation surfaces", async ({ page }, testInfo) => {
    ...
    await expect(page.getByText("Sri Shakti Shala").first()).toBeVisible();
    ...
    await attachRubric(testInfo, "desktop-design-intention-rubric", [
      ...
      },
      {
        ...
        status: "YES",
        evidence:
          "Portal and Shala surfaces expose `Sri Shakti Shala`, `Shakti Shadow & Somatics`, sanctuary language, and room names.",
      },
      {
      ...
      },
      {
        ...
        status: "YES",
        evidence:
          "Founder portrait, name, biography, and contextual Sri Shakti Shala connection are visible in the captured founder section.",
      },
      {
  ...
  test("mobile walkthrough preserves the founder and pathway hierarchy", async ({ page }, testInfo) => {
    ...
    await attachRubric(testInfo, "mobile-design-intention-rubric", [
      ...
      },
      {
        ...
        status: "YES",
        evidence:
          "Mobile portal and Shala states expose Sri Shakti Shala sanctuary language.",
      },
      {
        question: "Can I tell where to begin?",
        status: "YES",
